...
export default function calificacion() {
  ...
  return (
    <View style={styles.viewBtn}>
      ...
      <Image
        style={styles.photo}
        source={require('../../../assets/Calificar.jpg')}
      ...
      <Button
        ...
        buttonStyle={styles.btnStyle}
        containerStyle={styles.btnContainer}
        onPress={() => navigation.navigate("calificaciones-det")}
      />

      <Button
        title="Lista de calificaciones por alumno"
        buttonStyle={styles.btnStyle}
        containerStyle={styles.btnContainer}
        onPress={() => navigation.navigate("calificaciones-list")}
      />

      <Button
        title="Lista de calificaciones por carrera"
        buttonStyle={styles.btnStyle}
        containerStyle={styles.btnContainer}
        onPress={() => navigation.navigate("calificaciones-carr")}
      />
